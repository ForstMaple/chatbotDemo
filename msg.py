...
help_msg = "You can click the buttons below to get started. " \
           ...
           "*Game Query & Similarity-Based Recommendations:*\n" \
           ...
           "3. Click on `Find Similar Games` to get the similarity-based recommendations of the game\n" \
           "You can always click `Back` and reselect and click on different games to update the information\n\n" \
           "*Game Query & Similarity-Based Recommendations:*\n" \
           "1. Follow the prompt to describe the games\n" \
           "2. Click on the game you are interested in.\n" \
           "3. You can also click `Find Similar Games` to get the similarity-based recommendations of the game\n" \
           "You can always click `Back` and reselect and click on different games to update the information\n\n" \
           "*Game Filtering:*\n" \
...
ask_game_input_msg = "Please give me a game name! Full names will make better matches. " \
                     ...
                     "*Note:* You can click `Cancel` to go back to the main menu."

ask_desc_input_msg = "Please describe the game you want! " \
                     "You can just list some specific keywords, like action, fps, multiplayer, etc.\n\n\n" \
                     "*Note:* You can click `Cancel` to go back to the main menu."

confirm_game_input_msg = "Please click on a game to see the details."
